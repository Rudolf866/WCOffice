...
<div class="main">
    <div class="clients_list_table">
        <form id="list_edit_client" method="post" action="/iwater/backend.php">
            <div class="name_title">
                <div class="name_position">Список клиентов</div>
                <div class="add_position"><a href="http://iwatercrm.ru/iwater/admin/add_client/"><span class="img_add"></span>Добавить клиента</a></div>
            </div>
...
//                        cell = row.insertCell(-1).innerHTML = "id клиента";
                        ...
                        cell = row.insertCell(-1).innerHTML = '<div align="center">Контакт</div>';
...
//                            cell = row.insertCell(-1).innerHTML = '<input class="id_readonly" name="client_id[]" type="text" value="' + client_id + '" readonly>';
                            ...
                            i++;
                            cell = row.insertCell(-1).innerHTML = '<?php if ($access_level > 1) echo "<a title=\"Редактировать\" href=\"/iwater/admin/edit_clients?id='+db_id+'\"><div id=\"edit_order\" type=\"text\" role=\"textbox\" class=\"edit_clients\" style=\"background: url(../../css/image/edit.png) 0 0 no-repeat;background-size: contain; width:16px; height: 16px; margin: 0 auto; \"></div></a>"; ?>';
                            cell = row.insertCell(-1).innerHTML = '<a title="Список заказов" href="/iwater/admin/list_orders?client_order='+client_id+'"><div id="client_orders" type="text" role="textbox" class="order_list" style="    background: url(../../css/image/lists.png) 0 0 no-repeat;background-size: contain; width:16px; height: 16px; margin: 0 auto; "></div></a>';
