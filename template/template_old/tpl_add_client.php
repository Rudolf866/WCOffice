        ...
        <form id="add_client_form" class="main_form" method="post" action="/iwaterTest/backend.php">
            ...
            <div class="content_add">
                    <div class="left">
                        ...
                        <label for="contact[]" style="width: 100px">Телефон</label><input id="contact_" name="contact[]" type="text" placeholder="Телефон" style="width: 245px;"><input type="button" class="btn_add" id="add_objects" value="+">
                    </div>
                    <div class="right">
                        <a href="#" class="classic" onclick="check_point(this);add_placemarks();">Восстановить координаты </a>
                        <a href="#"
                   onclick="if($('#hidemap').css('display')!='none'){$('#hidemap').hide();}else{$('#hidemap').fadeIn().css( 'display', 'inline-block');add_placemarks();;}">Карта</a>  
...
//            if(value!=""){
//                result = false;
//                var name_elem = element.id.split('_');
//                if($("#cords_"+name_elem[1]).val() != ""){
//                    result = true;
//                }
//            }
...
//                error.insertBefore($("label[for='"+element.attr('name')+"']"));
