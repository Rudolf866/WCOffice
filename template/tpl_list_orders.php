...
<!--                    <p class="datepicker_p"><label for="time">Время: </label><input id="time" name="time" type="text">-->
            ...
            <div>
                ...
                }elseif (isset($_GET['mobile'])) {     // Поиск по телефону клиента
					$get = "order=order&mobile=" . $_GET['mobile'];
                ...
                <script type="text/javascript">
					...
					//var listName = ["", "", "id клиента","Клиент", "id", "Адрес", "Дата", "Время"];
...
//                                location.href = '/iwaterTest/files'+'.xlsx';
                    ...
                    function searchOrder() {
					  ...
					  //var url = "/iwaterTest/backend.php?<?echo $get.$getDate?>" + "&" + $(".edit_role option:selected").val() + "=" + $("#set_filter").val();
